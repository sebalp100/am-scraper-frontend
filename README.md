...
# 📖 Amazon Scraper Frontend<a name="about-project"></a>

Frontend made with vite that allows the user to scrape Amazon products.
...
You should have the Frontend running now. You can visit http://localhost:5173/ in your browser to access the website.
